...
font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif,Tatwerat_Light;
    ...
    <table width="100%">
        <tr>
            <td style="border: 0;  text-align: left" width="62%">
                <span style=" color: #2f4f4f"><strong><?php echo $_L['INVOICE']; ?> # تست<?php
                        if($d['cn'] != ''){
                            $dispid = $d['cn'];
                        }
                        else{
...
<hr>
    ...
    <table id="items" dir="rtl">
        ...
        <tr>
            <th width="65%"><?php echo $_L['Item']; ?>gsgg</th>
