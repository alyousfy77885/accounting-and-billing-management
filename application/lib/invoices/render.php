...
@font-face {
    ...
    src: url("fonts/HoboStd.eot?") format("eot"), url("fonts/HoboStd.otf") format("opentype"), url("fonts/HoboStd.ttf") format("truetype");
        ...
        * { margin: 0; padding: 0; }
        body {
     font-family:Tatwerat_Light;// dejavusanscondensed;

   
        }
        #page-wrap { width: 800px; margin: 0 auto; }

        textarea { border: 0;  overflow: hidden; resize: none; font-family: 'Tatwerat_Light';
    }
        ...
        #terms h5 { text-transform: uppercase; font: 13px Tatwerat_Light; letter-spacing: 10px; border-bottom: 1px solid black; padding: 0 0 8px 0; margin: 0 0 8px 0; }
        #terms textarea { width: 100%; text-align: center;}



        .delete-wpr { position: relative; }
        .delete { display: block; color: #000; text-decoration: none; position: absolute; background: #EEEEEE; font-weight: bold; padding: 0px 3px; border: 1px solid; top: -6px; left: -22px; font-family: Tatwerat_Light; font-size: 12px; }
...
<body  style="text-align:right;font-family: Tatwerat_Light
  ">
...
<div id="page-wrap">
    ...
    <div id="customer">
        ...
        <table id="meta" dir="rtl" style="font-family: Tatwerat_Light"
  >
            <tr>
                <td rowspan="5" style="border: 1px solid white; border-right: 1px solid black; text-align: right" width="62%">
    ...
    <table id="items" dir="rtl">

        <tr>
            <th width="65%"><?php echo $_L['Item']; ?>gsvv</th>
