...
$ui->assign('_application_menu', 'customers');
...
*/
    ...
    case 'summary':
        Event::trigger('contact/summary/');

        $cid = _post('cid');
        $d = ORM::for_table('crm_suppler')->find_one($cid);
        if ($d) {
    ...
    case 'activity':
        Event::trigger('contact/activity/');
    ...
    case 'invoices':
        Event::trigger('contact/invoices/');
    ...
    case 'transactions':
        Event::trigger('contact/transactions/');
    ...
    case 'add-activity-post':
        Event::trigger('contact/add-activity-post/');
    ...
    case 'activity-delete':
        Event::trigger('contact/activity-delete/');
    ...
    case 'view':
        Event::trigger('contact/view/');

        $id = $routes['2'];
        $d = ORM::for_table('crm_suppler')->find_one($id);
        if ($d) {
            $extra_tab = '';
            $extra_jq = '';
...
$ui->assign('type', 'supp');
            ...
            Event::trigger('contact/view/_on_start');
 ...
 ' . $extra_jq
            ...
            Event::trigger('contact/view/_on_display');

            $ui->display('account-profile-alt.tpl');
        } else {
            r2(U . 'suppler/list/', 'e', $_L['Account_Not_Found']);
        }
...
*/
 ...
 $d = ORM::for_table('sys_accounts')->create();
            ...
            $d = ORM::for_table('crm_suppler')->create();
            ...
            Event::trigger('contact/add-post/_on_finished');
    ...
    case 'list':
        ...
        if ($config['contact_set_view_mode'] == 'search') {
            ...
            $paginator = Paginator::bootstrap('crm_suppler');
            $d = ORM::for_table('crm_suppler')
                ->offset($paginator['startpoint'])
                ->limit($paginator['limit'])
                ->order_by_desc('id')
...
$ui->assign('type', 'supp');
    ...
    case 'edit-post':
        Event::trigger('contact/edit-post/');
    ...
    case 'edit-more':
        Event::trigger('contact/edit-more/');
    ...
    case 'edit-notes':
        Event::trigger('contact/edit-notes/');
    ...
    case 'render-address':
        Event::trigger('contact/render-address/');
...
";
    ...
    case 'modal_add':
        Event::trigger('contact/modal_add/');
    ...
    case 'set_view_mode':
        Event::trigger('contact/set_view_mode/');
    ...
    case 'export_csv':
        ...
        $results = db_find_array('crm_suppler', [
            'id',
            'account',
            'company',
            'phone',
 ...
 '
    ...
    case 'modal_view_company':
        ...
        if ($company) {
            ...
            Event::trigger('contact/modal_view_company/');
    ...
    case 'company_customers':
        ...
        $customers = ORM::for_table('crm_suppler')
            ->select('id')
            ->select('account')
            ->select('email')
            ->select('phone')
