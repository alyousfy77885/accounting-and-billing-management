    ...
    if (!$d) {
        ...
        if (Password::_verify($password, $d_pass) == true) {
            ...
            if ($d['otp'] == 'Yes') {
                ...
                _log('Login Successful ' . $username, 'Customer', $d['id']);
            ...
            _msglog('e', 'Invalid Ushhername or Password');
            _log('Failed Login ' . $username, 'Admin');
            r2(U . 'login');
        }
    } else {
        _msglog('e', 'Invalid gUsername or Password');

        r2(U . 'login/');
    }
} else {
    _msglog('e', 'Invalid Uhsername or Password');
