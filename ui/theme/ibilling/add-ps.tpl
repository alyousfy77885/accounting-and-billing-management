                    ...
                    <div class="ibox-content" id="ibox_form">
                        ...
                        <form class="form-horizontal" id="rform">
                            ...
                            <div class="form-group"><label class="col-lg-2 control-label" for="item_number">الكميه</label>
                             ...
                             <div class="form-group"><label class="col-lg-2 control-label" for="coun">{$_L['Item Number']}</label>

                                <div class="col-lg-10"><input type="text" id="coun" value="{$nxt}" name="coun" class="form-control" >
