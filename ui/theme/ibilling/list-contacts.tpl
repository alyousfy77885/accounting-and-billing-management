    ...
    {else}
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <a href="{$_url}contact/add/" class="btn btn-success"><i class="fa fa-plus"></i>اضافه مورد</a>
                        <a href="{$_url}contact/import_csv/" class="btn btn-primary"><i class="fa fa-upload"></i> {$_L['Import']}</a>
                        <a href="{$_url}contact/export_csv/" class="btn btn-info"><i class="fa fa-download"></i> {$_L['Export']}</a>
</div>


                        <form class="form-horizontal" method="post" action="{$_url}suppler/list/">
                            <div class="form-group">
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="{$_url}contact/add/" class="btn btn-success btn-block"><i class="fa fa-plus"></i>اضافه مورد جديد</a>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <ul class="tag-list" style="padding: 0">
                            {foreach $t as $ts}
                                <li><a href="{$_url}contact/list/{$ts['text']}/"><i class="fa fa-tag"></i> {$ts['text']}</a></li>
                            {/foreach}
                        </ul>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-hover sys_table">
                                ...
                                {foreach $d as $ds}
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{$_url}contact/view/{$ds['id']}/">{$ds['id']}</a> </td>
                                        ...
                                        <td><a href="{$_url}contact/view/{$ds['id']}/">{$ds['account']}</a> </td>
                                        <td>{$ds['company']}</td>
                                        ...
                                        <td class="text-right">
                                            <a href="{$_url}contact/view/{$ds['id']}/" class="btn btn-primary btn-xs"><i class="fa fa-search"></i> {$_L['View']}ا</a>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="contact-info">
                                    ...
                                    <p>
                                        <a href="{$_url}contact/view/{$ds['id']}/" class="btn btn-primary btn-xs"><i class="fa fa-search"></i> {$_L['View']}</a>
