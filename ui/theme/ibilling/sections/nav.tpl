<ul class="nav" id="side-menu">
    ...
    <li class="{if $_application_menu eq 'contacts'}active{/if}">
        <a href="#"><i class="icon-users"></i> <span class="nav-label" style="">{$_L['Customers']}</span><span class="fa arrow" style="float:left"></span></a>
    ...
    {if has_access($user->roleid,'suppler')}
    <li class="{if $_application_menu eq 'suppler'}active{/if}">
        <a href="#"><i class="icon-users"></i> <span class="nav-label" style="">الموردين</span><span class="fa arrow" style="float:left"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="{$_url}contacts/add/">اضافه مورد</a></li>

            <li><a href="{$_url}contacts/list/">عرض الموردين</a></li>
            {foreach $sub_menu_admin['crm'] as $sm_crm}
...
{$admin_extra_nav[3]}
    {if has_access($user->roleid,'catagory')}
        {if $_c['accounting'] eq '1'}
            <li class="{if $_application_menu eq 'catagory'}active{/if}">
                <a href="#"><i class="fa fa-database"></i> <span class="nav-label">{$_L['cat']}</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="{$_url}ps/c-new/">{$_L['newcat']}</a></li>
                    <li><a href="{$_url}ps/c-list/">{$_L['listcat']}</a></li>
                    </ul>
            </li>
        {/if}
    {/if}
    ...
    {if has_access($user->roleid,'orders')}
        ...
        {if ($_c['orders'] eq '1')}
            ...
            <li class="{if $_application_menu eq 'stock'}active{/if}">
                <a href="#"><i class="fa fa-server"></i> <span class="nav-label">المخزن</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="{$_url}stock/add/">اضافه الى المخزن</a></li>
                    <li><a href="{$_url}stock/list/">عرض المخزون</a></li>
