<?php
/* Smarty version 3.1.39, created on 2023-01-19 11:43:54
  from '/storage/emulated/0/RMS2/ibilling/ibilling/ui/theme/ibilling/sections/nav.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_63c9734a1c2258_54003309',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5e46793cb074c6a3d95000daf43b4f658df167b5' => 
    array (
      0 => '/storage/emulated/0/RMS2/ibilling/ibilling/ui/theme/ibilling/sections/nav.tpl',
      1 => 1674146468,
      2 => 'file',
    ),
  ),
...
function content_63c9734a1c2258_54003309 (Smarty_Internal_Template $_smarty_tpl) {
...
/"><i class="fa fa-tachometer"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Dashboard'];?>
    ...
    <li class="<?php if ($_smarty_tpl->tpl_vars['_application_menu']->value == 'contacts') {?>active<?php }?>">
        <a href="#"><i class="icon-users"></i> <span class="nav-label" style=""><?php echo $_smarty_tpl->tpl_vars['_L']->value['Customers'];?>
</span><span class="fa arrow" style="float:left"></span></a>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <?php echo $_smarty_tpl->tpl_vars['admin_extra_nav']->value[9];?>


    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'suppler')) {?>
    <li class="<?php if ($_smarty_tpl->tpl_vars['_application_menu']->value == 'suppler') {?>active<?php }?>">
        <a href="#"><i class="icon-users"></i> <span class="nav-label" style="">الموردين</span><span class="fa arrow" style="float:left"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
contacts/add/">اضافه مورد</a></li>

            <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
contacts/list/">عرض الموردين</a></li>
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['sub_menu_admin']->value['crm'], 'sm_crm');
$_smarty_tpl->tpl_vars['sm_crm']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['sm_crm']->value) {
...
<?php echo $_smarty_tpl->tpl_vars['admin_extra_nav']->value[3];?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'catagory')) {?>
        <?php if ($_smarty_tpl->tpl_vars['_c']->value['accounting'] == '1') {?>
            <li class="<?php if ($_smarty_tpl->tpl_vars['_application_menu']->value == 'catagory') {?>active<?php }?>">
                <a href="#"><i class="fa fa-database"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['cat'];?>
</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
ps/c-new/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['newcat'];?>
</a></li>
                    <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
ps/c-list/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['listcat'];?>
</a></li>
                    </ul>
            </li>
        <?php }?>
...
orders/add/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Add New Order'];?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'orders')) {?>
        ...
        <?php if (($_smarty_tpl->tpl_vars['_c']->value['orders'] == '1')) {?>
            ...
            <li class="<?php if ($_smarty_tpl->tpl_vars['_application_menu']->value == 'stock') {?>active<?php }?>">
                <a href="#"><i class="fa fa-server"></i> <span class="nav-label">المخزن</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
stock/add/">اضافه الى المخزن</a></li>
                    <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
stock/list/">عرض المخزون</a></li>
