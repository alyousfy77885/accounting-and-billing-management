$(document).ready(function () {
    ...
    $("#submit").click(function (e) {
        ...
        var _url = $("#_url").val();
        $.post(_url + 'contact/add-post/', $( "#rform" ).serialize())
            .done(function (data) {
                var sbutton = $("#submit");
                var _url = $("#_url").val();
                if ($.isNumeric(data)) {
                ...
                success: {
                    ...
                    callback: function () {
                        ...
                        if(group_name_val != ''){
                            ...
                            $.post( _url + "contact/add_group/", { group_name: group_name_val })
                                .done(function( data ) {

                                    if ($.isNumeric(data)) {

                                        window.location = _url + 'contact/add/' + data + '/';
    ...
    $('.add_company').on('click', function(e){
        ...
        $modal.load( _url + 'contact/modal_add_company/', '', function(){
    ...
    $modal.on('click', '.modal_submit', function(e){
        ...
        $.post( _url + "contact/add_company_post/", $("#ib_modal_form").serialize())
            .done(function( data ) {

                if ($.isNumeric(data)) {

                    window.location = base_url + 'contact/add/' + $("#group").val() + '/' + data;
