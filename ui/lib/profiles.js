$(document).ready(function () {
    ...
    function updateDiv(action,_url,cid,cb){
        ...
        if (window.history.replaceState) {
            window.history.replaceState( {} , '',  _url + 'contact/view/'+ cid +'/' + action + '/' );
        }
...
var sysrender = $('#application_ajaxrender');
    sysrender.on('click', '#acf-post', function(e){
        ...
        var _url = $("#_url").val();
        $.post(_url + 'contact/add-activity-post/', {
            ...
            .done(function (data) {
                ...
                if ($.isNumeric(data)) {
                    ...
                    window.location = _url + 'contact/view/' + data + '/activity/';
                }
                else {
                    $('#ibox_form').unblock();
    ...
    sysrender.on('click', '#submit', function(e){
        ...
        $ibox_form.block({ message: null });
        var _url = $("#_url").val();
        $.post(_url + 'contact/edit-post/', $( "#rform" ).serialize())
            .done(function (data) {
                ...
                if ($.isNumeric(data)) {
                    ...
                    window.location = _url + 'contact/view/' + data + '/edit/';
                }
                else {
                    $('#ibox_form').unblock();
        ...
        $.post(_url + 'contact/send_email/', {
            ...
            .done(function (data) {
                ...
                if ($.isNumeric(data)) {
                    ...
                    window.location = _url + 'contact/view/' + data + '/';
                }
                else {
                    $('#ibox_form').unblock();
        ...
        $.post(_url + 'contact/assign_file/', {
            ...
            .done(function (data) {
                ...
                if ($.isNumeric(data)) {
                    ...
                    window.location = _url + 'contact/view/' + data + '/files/';
                }
                else {
                    $('#ibox_form').unblock();
    ...
    sysrender.on('click', '.activity_edit', function(e){
        ...
        $modal.load( _url + 'contact/modal_edit_activity/' +  activity_id, '', function(){
    ...
    $modal.on('click', '.modal_activity_submit', function(e){
        ...
        $.post( _url + "contact/edit_activity_post/", $("#ib_modal_edit_activity_form").serialize())
            .done(function( data ) {
